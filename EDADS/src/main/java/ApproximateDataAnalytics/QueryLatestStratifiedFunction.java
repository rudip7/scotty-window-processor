...
public class QueryLatestStratifiedFunction<Q extends TimestampedQuery, S extends StratifiedSynopsis, O extends Serializable> extends KeyedBroadcastProcessFunction<Q, WindowedSynopsis<S>, QueryResult<Q,O>> {
    ...
    public QueryLatestStratifiedFunction(QueryFunction<Q, S, O> queryFunction) {
