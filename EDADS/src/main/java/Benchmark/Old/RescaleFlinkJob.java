...
// */
//public class RescaleFlinkJob<S extends MergeableSynopsis> {
//
//	public RescaleFlinkJob(String configuration, List<Window> assigners, StreamExecutionEnvironment env, final long runtime,
...
//				} else {
//					synopsesStream = BuildSynopsisRescale.timeBasedRescaled(timestamped, Time.milliseconds(((SlidingWindow) assigners.get(0)).getSize()), Time.milliseconds(((SlidingWindow) assigners.get(0)).getSlide()), 0, synopsisClass, parameters);
//				}
//			} else {
