...
public class StratifiedQuerySource extends RichParallelSourceFunction<Tuple2<Integer, Integer>> {
    ...
    public void run(SourceContext<Tuple2<Integer, Integer>> ctx) throws Exception {
        ...
        while (System.currentTimeMillis() < endTs){
            ...
            for (int i = 0; i < throughput; i++) {
                ctx.collectWithTimestamp(new Tuple2<>(random.nextInt(stratification), random.nextInt()), time);
            }
