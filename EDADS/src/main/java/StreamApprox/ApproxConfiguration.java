...
public class ApproxConfiguration {
    ...
    public int parallelism; // amount of parallelism the job should have
    ...
    public Source source;   // Uniform or Zipf distributed source
    public String logfile; // name the logfile for this flink-job should have
